...
void szjm_laotie()
{
  ...
  if (szjm_laotie_kxxk_count == 3) //第2页
  {
    ...
    if (hfccsz_state == 1)  u8g2.print("YES");
    else u8g2.print("NO");
  }
  else //第1页
  {
  ...
  switch (szjm_laotie_kxxk_count) //空心选框的位置
  {
    ...
    case 2:  //开机加热？
      ...
      {
        u8g2.setDrawColor(2);
        u8g2.drawBox(szjm_laotie_x1 - 2, szjm_laotie_y2 - 13, 128, 16); //实心方形
        u8g2.setDrawColor(1);
      }
      else u8g2.drawFrame(szjm_laotie_x1 - 2, szjm_laotie_y2 - 13, 128, 16); //空心方形
      break;
    case 3:  //恢复出厂设置
      if (szjm_laotie_sxxk_count == szjm_laotie_kxxk_count)
      {
