...
void zjm()
{
  ...
  if (t12_error == 0 && t12_adc_error == 0) //正常画面
  {
    ...
    if (t12_switch == 1 && (thisError_average <= 4 && thisError_average >= -4)) {
      if (t12_temp_average - t12_temp_display > 0) t12_temp_display += 1;
      else if (t12_temp_average - t12_temp_display < 0) t12_temp_display -= 1;
      u8g2.print(t12_temp_display);
    }

    else {
      if (t12_temp - t12_temp_display > 0) t12_temp_display += 1;
      else if (t12_temp - t12_temp_display < 0) t12_temp_display -= 1;
      u8g2.print(t12_temp_display);
    }
  }
  ...
  if (set_temp <= 310)u8g2.setCursor(zjm_x1 + 5, zjm_dh_y + 29); //画设置温度
  else u8g2.setCursor(zjm_x1 - 21, zjm_dh_y + 29);   //画设置温度
  u8g2.print(set_temp);
